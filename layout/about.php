...
<div class="wrapper">
  ...
  <div class="warpper-mid">
    ...
    <div class="mid-left">
      <h2 style="padding: 20px 0px 5px 30px;">About  <span>Us</span></h2><br><br>
      <center><img src="images\lalll.gif" width="570" height="250"> </center><br>  
      <div>
        <p class="txt-2" align="justify" style="padding: 10px 0px 5px 30px;">
            
        For all types of  law agencies need to manage their records in such a way 
        that they can retrieve the information as per requirement. They need a set of rulebooks, 
        such as Detail of clients, Staff, cases, and lawyers etc. Unless the transactions are recorded properly, 
        Accountant will not be in a position to know where exactly he stands. Therefore, 
        any business record keeping is of foremost importance.
        Handling the Law Agency manually is quite difficult so this software provides aid to the manage by providing 
        easy access to the records. This will improve the efficiency of the work because manually it would take a long time 
        to search for and keep track of all the records of the transactions taking place in the company. 
